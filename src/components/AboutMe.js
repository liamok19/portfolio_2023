          ...
          <div id="AboutMe" className="aboutMeCollection">
            <div className="column-1">
              <h2 tabIndex={0} className="introDescription">
                ...
                University of Sydney and Trinity College Education and completed
                a certificate in Full Stack Web Development. I have a creative
                flare and I owe that to working in the VFX and Animation
                Industry for over 8 years. From this I have a wealth of
                experience managing productions involving Artists, Directors,
                Admin, Production, and Marketing team members. During the Full
